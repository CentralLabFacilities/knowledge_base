...
secretroom = Room(name='secret room', numberofdoors='0')
inspectionpoint = Location(name='inspection point', room=secretroom)
inspectionend = Location(name='inspection end', room=secretroom)
helpmecarrystart = Location(name='help me carry start', room=secretroom)
cocktailpartystart = Location(name='cocktail party start', room=secretroom)
partyarea = Location(name='party area', room=secretroom)
gpsrstarta = Location(name='gpsr start a', room=secretroom)
gpsrstartb = Location(name='gpsr start b', room=secretroom)
arena_rooms.append(secretroom)
