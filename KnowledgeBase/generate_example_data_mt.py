...
fridge = Location(name='fridge', room=bedroom, isbeacon='True')
cabinet = Location(name='cabinet', room=bedroom, isplacement='True')
...
objs.append(Rcobject(name="cloth",         category='cleaning stuff', color="orange",             location=livingtable, shape="quite flat", size='4', weight='1'))
objs.append(Rcobject(name="scrubby",        category='cleaning stuff', color="yellow and green",          location=kitchencounter, shape="boxy", size='2', weight='1'))
objs.append(Rcobject(name="sponge",          category='cleaning stuff', color="pink",  location=cabinet, shape="boxy", size='3', weight='1'))
objs.append(Rcobject(name="basket",     category='containers', color="white",            location=bar, shape="boxy", size='5', weight='4'))
objs.append(Rcobject(name="tray",           category='containers', color="white",                   location=bar, shape="quadratic and flat", size='5', weight='4'))
objs.append(Rcobject(name="chocolate drink",     category='drinks', color="white and brown",    location=kitchencounter, shape="cylindrical", size='3', weight='4'))
objs.append(Rcobject(name="coke",        category='drinks', color="red",       location=kitchencounter, shape="cylindrical", size='2', weight='3'))
objs.append(Rcobject(name="grape juice",   category='drinks', color="white and red",       location=bar, shape="boxy", size='2', weight='3'))
objs.append(Rcobject(name="orange juice",           category='drinks', color="white and orange",        location=kitchencounter, shape="boxy", size='2', weight='3'))
objs.append(Rcobject(name="sprite",          category='drinks', color="blue",             location=cabinet, shape="cylindrical", size='2', weight='3'))
objs.append(Rcobject(name="cereal",       category='food', color="yellow",                location=sofa, shape="boxy", size='3', weight='1'))
objs.append(Rcobject(name="noodles",       category='food', color="green and white",               location=livingtable, shape="boxy", size='3', weight='1'))
objs.append(Rcobject(name="sausages",           category='food', color="blue and red",         location=kitchencounter, shape="cylindrical", size='1', weight='2'))
objs.append(Rcobject(name="apple",         category='fruits', color="red or green",  location=sink, shape="round", size='1', weight='1'))
objs.append(Rcobject(name="orange",         category='fruits', color="orange",  location=sink, shape="round", size='1', weight='1'))
objs.append(Rcobject(name="paprika",   category='fruits', color="red",          location=kitchencounter, shape="rather round", size='2', weight='2'))
objs.append(Rcobject(name="crackers",          category='snacks', color="orange",            location=bar, shape="quadratic and flat", size='1', weight='1'))
objs.append(Rcobject(name="potato chips",          category='snacks', color="orange",            location=bar, shape="couldy", size='5', weight='3'))
objs.append(Rcobject(name="pringles",          category='snacks', color="green",            location=bar, shape="cylindrical", size='5', weight='3'))
