...
entrance = Location(name='entrance', room=corridor, isbeacon='True')
arena_rooms.append(corridor)
arena_locations.append(entrance)


bedroom = Room(name='bedroom', numberofdoors='2')
bed = Location(name='bed', room=bedroom, isbeacon='True')
sidetable = Location(name='side table', room=bedroom, isbeacon='True', isplacement='True')
desk = Location(name='desk', room=bedroom, isbeacon='True', isplacement='True')
...
diningtable = Location(name='dining table', room=diningroom, isbeacon='True', isplacement='True')
arena_rooms.append(diningroom)
arena_locations.append(diningtable)


livingroom = Room(name='living room', numberofdoors='2')
exit = Location(name='exit', room=corridor, isbeacon='True')
couch = Location(name='couch', room=livingroom, isbeacon='True')
endtable = Location(name='end table', room=livingroom, isbeacon='True', isplacement='True')
bookcase = Location(name='bookcase', room=livingroom, isbeacon='True', isplacement='True')
...
cupboard = Location(name='cupboard', room=kitchen, isbeacon='True', isplacement='True')
storagetable = Location(name='storage table', room=kitchen, isbeacon='True', isplacement='True')
...
dishwasher = Location(name='dishwasher', room=kitchen, isbeacon='True')
...
objs.append(Rcobject(name="cascade pod",         category='cleaning stuff', color="mostly white",             location=sidetable, shape="boxy", size='1', weight='1'))
